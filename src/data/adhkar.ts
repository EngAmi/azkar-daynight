...
const rawAdhkar: Dhikr[] = [
  ...
  {
    id: 40,
    content: "اللَّهُمَّ أَنْتَ خَلَقْتَنِي وَأَنْتَ تَهْدِينِي وَأَنْتَ تُطْعِمُنِي وَأَنْتَ تَسْقِينِي وَأَنْتَ تُمِيتُنِي وَأَنْتَ تُحْيِينِي",
    count: 1,
    countDescription: "مَرَّةٌ وَاحِدَةٌ",
    fadl: "مَنْ قَالَ إِذَا أَصْبَحَ وَإِذَا أَمْسَى: اللَّهُمَّ أَنْتَ خَلَقْتَنِي وَأَنْتَ تَهْدِينِي وَأَنْتَ تُطْعِمُنِي وَأَنْتَ تَسْقِينِي وَأَنْتَ تُمِيتُنِي وَأَنْتَ تُحْيِينِي، لَمْ يَسْأَلِ اللَّهَ شَيْئًا إِلَّا أَعْطَاهُ إِيَّاهُ. وَقَالَ: فَلَقِيتُ عَبْدَ اللَّهِ بْنَ سُلَيْمٍ فَقُلْتُ: أَلَا أُحَدِّثُكَ حَدِيثًا سَمِعْتُهُ مِنْ رَسُولِ اللَّهِ ﷺ مِرَارًا وَمِنْ أَبِي بَكْرٍ مِرَارًا وَمِنْ عُمَرَ مِرَارًا؟ قَالَ: بَلَى، فَحَدَّثْتُهُ بِهَذَا الْحَدِيثِ، فَقَالَ: بِأَبِي وَأُمِّي قَالَ رَسُولُ اللَّهِ ﷺ: هَؤُلَاءِ الْكَلِمَاتُ كَانَ اللَّهُ عَزَّ وَجَلَّ قَدْ أَعْطَاهُنَّ مُوسَى عَلَيْهِ السَّلَامُ، فَكَانَ يَدْعُو بِهِنَّ فِي كُلِّ يَوْمٍ سَبْعَ مَرَّاتٍ، فَلَا يَسْأَلُ اللَّهَ شَيْئًا إِلَّا أَعْطَاهُ إِيَّاهُ. خَلَاصَةُ حُكْمِ الْمُحَدِّثِ: إِسْنَادُهُ حَسَنٌ. الرَّاوِي: سَمُرَةُ بْنُ جُنْدُبٍ | الْمُحَدِّثُ: الْمُنْذِرِيُّ | الْمَصْدَرُ: التَّرْغِيبُ وَالتَّرْهِيبُ 1/314. التَّخْرِيجُ: أَخْرَجَهُ الطَّبَرَانِيُّ فِي الْمُعْجَمِ الْأَوْسَطِ (1028) بِلَفْظِهِ.",
    source: "الترغيب والترهيب 1/314، والطبراني في المعجم الأوسط 1028",
    type: 0,
  },
];
