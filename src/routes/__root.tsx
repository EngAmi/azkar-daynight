  ...
  head: () => ({
    ...
    scripts: [
      ...
      },
      {
        type: "text/javascript",
        children:
          "(function(){try{var m={amiri:[\"'Amiri','Amiri Fallback',serif\",1,1,0.04,0.025,1.15,'cozy'],naskh:[\"'Noto Naskh Arabic','Amiri',serif\",0.94,1.04,0.02,0.01,1.25,'relaxed'],scheherazade:[\"'Scheherazade New','Amiri',serif\",1.06,1.06,0.06,0,1.35,'relaxed'],tajawal:[\"'Tajawal','Noto Naskh Arabic',sans-serif\",0.92,1.06,0.01,0,1.1,'cozy']};var sp={compact:[0.9,0.7,0.8],cozy:[1,1,1],relaxed:[1.14,1.4,1.3]};var f=localStorage.getItem('azkar-arabic-font')||'amiri';if(!m[f])f='amiri';var d=m[f];var s=d[6];try{var raw=localStorage.getItem('azkar-arabic-spacing');if(raw){var o=JSON.parse(raw);if(o&&sp[o[f]])s=o[f];}}catch(e2){}var k=sp[s]||sp.cozy;var r=document.documentElement;r.style.setProperty('--arabic-font',d[0]);r.style.setProperty('--arabic-font-adjust',String(d[1]));r.style.setProperty('--arabic-leading-adjust',String(d[2]*k[0]));r.style.setProperty('--arabic-word-spacing',(d[3]*k[1])+'em');r.style.setProperty('--arabic-letter-spacing',(d[4]*k[1])+'em');r.style.setProperty('--arabic-block-gap',(d[5]*k[2])+'rem');r.setAttribute('data-arabic-font',f);r.setAttribute('data-arabic-spacing',s);}catch(e){}})();",
      },
      {
        type: "text/javascript",
        children:
          "(function(){try{var v=localStorage.getItem('azkar-a11y-mode');if(v==='1'){document.documentElement.classList.add('a11y-mode');}}catch(e){}})();",
      },
